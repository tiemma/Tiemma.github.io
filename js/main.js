$(document).ready(function() {
  ...
  $('.chart').easyPieChart({
    ...
    onStep : function(
        from, to,
        percent) { $(this.el).find('span').text(Math.round(percent)); }
  });
  ...
  $container.imagesLoaded(
      function() { $('.isotope').isotope({itemSelector : '.item'}); });
  ...
  const template = (data) => {
    data.responsibilities
        ? data.responsibilities =
              data.responsibilities.map(data => `<li>${data}</li>`)
        : null;
    return `
           <div class="item">
  ...
  const work_experiences = [
    ...
    },
    {
      ...
      responsibilities : [
        "Maintained systems in Go", "Work with OpenBSD systems",
  ...
  const leadership_experiences = [
    ...
    },
    {
      place : "AIESEC",
      url :
          "https://www.slideshare.net/slideshow/embed_code/key/n1cuZ49UisTvcO",
      title : "Team Member",
      location : "UNILAG",
  ...
  leadership_experiences.forEach(function(
      data) { $('#leadership-timeline').append(template(data)); });

  const talks_experiences = [
    {
      place : "Hashitalks Africa",
      url : "https://speakerdeck.com/tiemma/end-to-end-testing-with-terratest",
      title : "End to End Testing with Terratest",
      location : "Youtube",
      job_title : "Speaker",
      timeline : "Apr. 30 2020",
    },
    {
    ...
    },
    {
      place : "DevFest Ajah",
      url :
          "https://speakerdeck.com/tiemma/devfest-ajah-2019-understanding-ci-cd",
    ...
    },
    {
      place : "PyCon Nigeria",
      url :
          "https://speakerdeck.com/tiemma/event-driven-architecture-the-right-way",
    ...
    },
    {
      ...
      url :
          "https://speakerdeck.com/tiemma/gdg-ojo-festac-managing-api-deployments-on-cloud-endpoints",
    ...
    },
    {
      place : "DevFest Ajah",
      url :
          "https://speakerdeck.com/tiemma/gdg-devfest-2018-kubernetes-your-go-to-orchestration-tool",
  ...
  talks_experiences.forEach(function(
      data) { $('#talks-timeline').append(template(data)); });
});
